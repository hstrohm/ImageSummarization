...
### Key Takeaways
* When many objects are detected, it is hard to succinctly summarize the image as it's hard to determine which of those objects are the most important in that image. Something like size would miss important small objects and detection certainty from the NN doesn't make sense at all. 
